...
var boolArr = [true, true, false, true, false]
...
admitted.append(contentsOf: waitingList.dropLast(2))
//: ### Exercise 7
//: Using subscript syntax, print out the 2nd and 3rd names from the admitted array.
print("second: \(admitted[1]), second: \(admitted[2])")
...
var foodilike = ["Anchovies": false, "Coconut": true, "Cilantro": true, "Liver": false]
